...
public final class FragmentSignupTabBinding implements ViewBinding {
  ...
  private FragmentSignupTabBinding(@NonNull LinearLayout rootView, @NonNull Button signupButton,
  ...
  public static FragmentSignupTabBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_signup_tab, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentSignupTabBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSignupTabBinding((LinearLayout) rootView, signupButton, signupConfirm,
